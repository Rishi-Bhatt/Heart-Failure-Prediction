...
echo -e "${YELLOW}Running Heart Failure Prediction System with Unique ECG and Abnormalities${NC}"
echo "========================================================"
...
echo -e "\n${YELLOW}Starting backend test server with unique ECG and abnormalities...${NC}"
cd backend
...
echo "2. Go to the Patient History page to see all saved patients"
echo "3. Click 'View Details' on any patient to see their unique ECG and abnormalities"
echo "4. Compare different patients to see how their ECG patterns and abnormalities differ"
echo "5. Each patient should now have a unique ECG and set of abnormalities based on their data"
wait
