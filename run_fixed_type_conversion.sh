...
echo -e "${YELLOW}Running Heart Failure Prediction System with Fixed Type Conversion${NC}"
echo "========================================================"
...
echo -e "\n${YELLOW}Starting backend test server with type conversion fixes...${NC}"
cd backend
...
echo "1. Enter different patient data to see unique ECG patterns and abnormalities"
echo "2. Try patients with different risk factors (age, heart rate, prior events, etc.)"
echo "3. All form fields should now work correctly with proper type conversion"
wait
