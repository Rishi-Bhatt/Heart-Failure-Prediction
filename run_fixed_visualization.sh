...
echo -e "${YELLOW}Running Heart Failure Prediction System with Fixed Visualizations${NC}"
echo "========================================================"
...
echo -e "\n${YELLOW}Starting backend test server with patient-specific visualizations...${NC}"
cd backend
...
echo "3. Compare the visualizations between different patients"
wait
