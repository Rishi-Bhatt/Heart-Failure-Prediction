...
echo -e "${YELLOW}Running Heart Failure Prediction System with Research-Grade Hybrid Model${NC}"
echo "========================================================"
...
echo -e "\n${YELLOW}Starting backend test server with hybrid research model...${NC}"
cd backend
...
echo -e "\n${GREEN}Research Model Information:${NC}"
echo "1. This system uses a hybrid model combining rule-based and ML approaches"
echo "2. The ML component is a Clinically-Informed Logistic Regression model"
echo "3. Clinical domain knowledge is incorporated through informed priors"
echo "4. The system adapts and improves with feedback and retraining"
echo "5. Predictions include detailed explanations suitable for research publication"
echo -e "\n${GREEN}Testing Instructions:${NC}"
echo "1. Enter patient data and submit the form to create new patient records"
echo "2. Review the prediction results and explanations"
...
echo "6. Export the model's performance metrics for your research paper"
wait
