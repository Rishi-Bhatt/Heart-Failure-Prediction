...
This script tests the model trained on the large dataset to ensure it works correctly
...
def test_large_dataset_model():
    """
    Test the model trained on the large dataset
    """
    print("\nTesting Model Trained on Large Dataset")
    print("=" * 60)
    ...
    print("\nLarge dataset model test completed!")

if __name__ == "__main__":
    test_large_dataset_model()
