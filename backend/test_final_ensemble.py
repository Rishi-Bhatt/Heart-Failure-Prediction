...
This script tests the final ensemble model with the updated weights to ensure
...
def test_final_ensemble():
    """
    Test the final ensemble model with different risk profiles
    """
    print("\nTesting Final Ensemble Model with Different Risk Profiles")
    print("=" * 60)
